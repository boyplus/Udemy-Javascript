...
var budgetController = (function () {
    ...
    return {
        addItem: function (type, des, val) {
            ...
            //Create new item base on exp, inc
            if (type === 'exp') {
        ...
        deleteItem: function (type, id) {
            var index, ids;
            //map method will return the brand new array by our function
        ...
        calculatePercentages: function () {
            data.allItems.exp.forEach(function (current) {
                //Calculate the percentages for every element in exp
...
var UIController = (function () {
    ...
    //We will return the object of function
    return {
        getInput: function () {
            var input = {
        ...
        addListItem: function (obj, type) {
            ...
            //Replace some placeholder with actual data
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var ctrlDeleteItem = function () {
        ...
        if (itemId) {
            ...
            //2.Delate the item from UI
            UICtrl.deleteListItem(itemId);
            //3.Update and show the new budget
            updateBudget();
            //4.calculate and update the precentage
            updatePercentages();
        }
    };
    return {
